...
export const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  ...
  return (
    <footer id="contact" className="bg-[#07152B] text-white pt-16 pb-10 border-t border-slate-800/80 relative overflow-hidden">
            ...
            <ul className="space-y-2.5 text-xs sm:text-[13px] text-slate-400">
              <li>
                <button
                  ...
                  className="hover:text-white hover:translate-x-0.5 transition-all cursor-pointer"
                >
                  Home
                </button>
              </li>
          ...
          <div className="lg:col-span-2 space-y-3.5">
            ...
            <div className="flex items-center gap-2.5 text-slate-300">
              <a
                ...
                className="w-9 h-9 rounded-full border border-slate-700 bg-white/5 flex items-center justify-center hover:bg-[#0276FD] hover:border-[#0276FD] hover:text-white hover:scale-110 transition-all"
              >
