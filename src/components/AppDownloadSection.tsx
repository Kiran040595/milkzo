...
export const AppDownloadSection: React.FC = () => {
  ...
  return (
    <section className="relative py-10 sm:py-14 lg:py-16 xl:py-20 bg-[#E5F1FC] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 xl:gap-10 items-center">
          ...
          <div className="lg:col-span-5 space-y-3 sm:space-y-4 text-center lg:text-left">
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-[32px] xl:text-[38px] font-black text-[#0A1E3F] tracking-tight leading-tight">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2.5 pt-2 sm:pt-3">
              {/* App Store */}
              <a
                href="#app-store"
                className="inline-flex items-center gap-2.5 px-4 py-2 bg-black hover:bg-slate-900 text-white rounded-xl shadow-md transition-all duration-200 active:scale-95"
              >
          ...
          <div className="lg:col-span-4 flex items-center justify-center relative">
            <div className="relative w-52 sm:w-60 lg:w-64">
              <img
