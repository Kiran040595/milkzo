...
interface TrailsPackPageProps {
  onBackToHome: () => void;
  onBookTrial: (data: TrialOrderData) => void;
}

export const TrailsPackPage: React.FC<TrailsPackPageProps> = ({
  onBackToHome,
  onBookTrial,
}) => {
  ...
  // Handle unlock action with animation
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f0f7ff] via-white to-blue-50/30 py-8 sm:py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Top Breadcrumb / Back Bar */}
        <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-200/80">
          <button
            onClick={onBackToHome}
            className="group inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-slate-600 hover:text-[#0276FD] transition-colors cursor-pointer bg-white px-3.5 py-2 rounded-xl border border-slate-200/80 shadow-2xs"
          >
            <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
            <span>Back to Home</span>
          </button>

          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-100/70 text-[#0276FD] text-xs font-black uppercase tracking-wider border border-blue-200">
            <Sparkles className="w-3.5 h-3.5 text-amber-500 fill-amber-400" />
            <span>Dedicated Trial Portal</span>
          </div>
        </div>

        {/* Section Header */}
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#0A1E3F] tracking-tight leading-tight">
          ...
          <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="mt-12 pt-10 border-t border-slate-200">
              <div className="text-center max-w-xl mx-auto mb-8">
                <div className="inline-flex items-center gap-1.5 text-xs font-black uppercase text-[#0276FD] bg-blue-50 px-3 py-1 rounded-full mb-2">
                  <HelpCircle className="w-3.5 h-3.5" />
                  <span>Trial Pack FAQs</span>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-2xs space-y-1.5">
                  <h4 className="font-bold text-sm text-[#0A1E3F]">
                    What time will my trial pack be delivered?
                  </h4>
                  <p className="text-slate-600 leading-relaxed">
                    All trial deliveries are completed at your doorstep between 5:30 AM and 7:00 AM every morning in insulated cold-chain bags.
                  </p>
                </div>

                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-2xs space-y-1.5">
                  <h4 className="font-bold text-sm text-[#0A1E3F]">
                    Will my card or subscription auto-renew after the trial?
                  </h4>
                  <p className="text-slate-600 leading-relaxed">
                    No! There is zero auto-debit or auto-renewal. Your trial automatically concludes after the chosen 5 or 7 days unless you decide to continue.
                  </p>
                </div>

                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-2xs space-y-1.5">
                  <h4 className="font-bold text-sm text-[#0A1E3F]">
                    Can I modify my start date or pause days?
                  </h4>
                  <p className="text-slate-600 leading-relaxed">
                    Yes. Once booked, our customer support team connects with you and you can adjust the schedule or pause any days with a single message.
                  </p>
                </div>

                <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-2xs space-y-1.5">
                  <h4 className="font-bold text-sm text-[#0A1E3F]">
                    What is included with the 7-Day Trial?
                  </h4>
                  <p className="text-slate-600 leading-relaxed">
                    The 7-Day trial includes 7 sunrise milk packets plus a complimentary 100g Fresh Farm Paneer sample delivered fresh on Day 4 of your trial!
                  </p>
                </div>
              </div>
            </div>
